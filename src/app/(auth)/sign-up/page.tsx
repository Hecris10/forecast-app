...
export default function SignUp() {
  ...
  return (
    <Card className="z-50 rounded-none min-h-screen w-screen flex flex-col items-center justify-center">
      ...
      <CardFooter className="w-full max-w-xl mx-auto">
        <Link
          className="text-muted-foreground text-sm mx-auto text-center"
          href="/sign-in"
        >
